...
public class ArduinoClassExampleSketch extends ArduinoClassMaster {
	 ...
	 */
	public ArduinoClassExampleSketch(String className, libraryOptionalFields fields,
			String headerComments, String sketchMethods, String publicMethods) {
	...
	public static void main(String[] args) {
		...
		libraryOptionalFields fields=new libraryOptionalFields(ArduinoClassExample.AUTHOR.toString(), ArduinoClassExample.ORGANIZATION.toString(), 
